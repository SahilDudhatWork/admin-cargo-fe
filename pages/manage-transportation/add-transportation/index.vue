  ...
  <div>
    <div>
      ...
      <form
        ...
        @submit.prevent="addTransportation"
      >
        <div
...
export default {
  ...
  methods: {
    ...mapActions({
      createTransportation: "transitinfo/createTransportation",
    }),
    ...
    async addTransportation() {
      try {
        ...
        const res = await this.createTransportation(this.typeOfTransportation);
        this.$toast.open({
          message: res.msg,
        });
