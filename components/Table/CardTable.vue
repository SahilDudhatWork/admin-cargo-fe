      ...
      <div class="relative overflow-x-auto">
        ...
        >
          ...
          <button
            ...
            :disabled="cardPaginationData.pre_page_url === null"
            :class="
              cardPaginationData.pre_page_url === null
                ? 'bg-[#89abcf]'
                : 'bg-[#3683D5]'
            "
          >
          ...
          <button
            @click="$emit('nextPage')"
            class="p-[9px] rounded-lg"
            :disabled="cardPaginationData.next_page_url === null"
            :class="
              cardPaginationData.next_page_url === null
                ? 'bg-[#89abcf]'
                : 'bg-[#3683D5]'
            "
          >
